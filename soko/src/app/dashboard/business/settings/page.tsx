...
export default function BusinessSettingsPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-10 space-y-6">
      ...
      <div>
        <h2 className="font-display text-xl font-bold mb-1">Vifaa vya Kutangaza</h2>
        <p className="text-night/50 text-sm mb-4">
          Tumia hivi kuwaambia wateja wako wa kawaida waanze kuagiza kupitia Soko — bila kujibu "bei gani" tena kila siku.
        </p>

        {slug && (
          <Link
            href="/api/business/price-list"
            target="_blank"
            className="btn btn-primary w-full mb-4"
          >
            🖼️ Pakua Bei List (kwa WhatsApp Status)
          </Link>
        )}

        {slug && <ShopQRCode slug={slug} />}
      </div>
    </div>
  );
}