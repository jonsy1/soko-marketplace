  ...
  return (
    <>
      <div className="group relative bg-white rounded-2xl border border-night/5 hover:border-night/15 hover:shadow-xl transition-all duration-300 overflow-hidden">
        ...
        {/* Product Info */}
        <div className="p-3">
          {/* Business name with Contact Seller button */}
          <div className="flex items-center justify-between mb-1">
            {product.business && (
              <Link
                href={`/business/${product.business.slug}`}
                className="text-[10px] text-market-500 uppercase tracking-wider font-medium hover:underline transition flex-1"
              >
            ...
            {product.business && (
              <button
                ...
                className="text-lg hover:scale-110 transition ml-1"
      ...
      <ContactSellerModal
        ...
        businessName={product.business?.name || 'Seller'}
      />
    </>
  );
}
